...
export default function PetCard({ pet }: { pet: Pet }) {
  ...
  return (
    <div
      className={`rounded-2xl p-3 bg-zinc-900/60 border ${rarityColor[pet.rarity]} flex flex-col items-center gap-2`}
    >
      ...
      {!owned ? (
        ...
        <button
          onClick={equip}
          className={`mt-2 px-3 py-1 rounded-lg text-sm transition ${
            equipped
